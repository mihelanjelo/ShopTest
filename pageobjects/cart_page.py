...
class CartPage:
    ...
    def select_create_account_checkbox(self):
        create_account_checkbox = WebDriverWait(self.driver, 3).until(
    ...
    def set_desired_password(self, desired_password):
        desired_password_field = WebDriverWait(self.driver, 5).until(
    ...
    def set_confirmed_password(self, confirmed_password):
        confirmed_password_field = WebDriverWait(self.driver, 5).until(
    ...
    def click_save_changes_button(self):
        save_changes_button = WebDriverWait(self.driver, 5).until(
            EC.element_to_be_clickable(self.save_changes_button_locator))
        save_changes_button.click()

    def is_account_created_alert_visible(self):
